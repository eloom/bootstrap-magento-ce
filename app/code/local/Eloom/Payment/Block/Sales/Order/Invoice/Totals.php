...
class Eloom_Payment_Block_Sales_Order_Invoice_Totals extends Mage_Sales_Block_Order_Invoice_Totals {
	...
	protected function _initTotals() {
		...
		$amt = $this->getSource()->getMercadopagoDiscountAmount();
		if ($amt != 0) {
			$this->addTotalBefore(new Varien_Object(array(
				'code' => 'eloom_mercadopago_discount',
				'value' => $amt,
				'base_value' => $this->getSource()->getMercadopagoBaseDiscountAmount(),
