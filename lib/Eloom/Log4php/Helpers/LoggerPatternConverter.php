...
/**
 * Eloom_Log4php_Helpers_LoggerPatternConverter is an abstract class that provides the formatting 
 ...
 * @since 0.3
 */
class Eloom_Log4php_Helpers_LoggerPatternConverter {
	
	/**
	 * Array for fast space padding
	 * Used by {@link Eloom_Log4php_Helpers_LoggerPatternConverter::spacePad()}.	
	 */
	...
	/**
	 * @var Eloom_Log4php_Helpers_LoggerPatternConverter next converter in converter chain
	 */
	public $next = null;
	 ...
	 * Constructor 
	 *
	 * @param Eloom_Log4php_Helpers_LoggerFormattingInfo $fi
	 */
	 ...
	 * @param Eloom_Log4php_LoggerLoggingEvent $e
	 */
