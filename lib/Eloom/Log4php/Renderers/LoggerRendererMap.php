...
/**
 * Log objects using customized renderers that implement {@link Eloom_Log4php_Renderers_LoggerRendererObject}.
 *
 * Example:
 ...
 * @since 0.3
 */
class Eloom_Log4php_Renderers_LoggerRendererMap {
	...
	public function __construct() {
		$this->map = array();
		$this->defaultRenderer = new Eloom_Log4php_Renderers_LoggerRendererDefault();
	}
	 ...
	 *
	 * @param Eloom_Log4php_LoggerHierarchy $repository a logger repository.
	...
	public function addRenderer($renderedClassName, $renderingClassName) {
		$renderer = Eloom_Log4php_LoggerReflectionUtils::createObject($renderingClassName);
		if($renderer == null) {
			return;
		} else {
	 ...
	 * method if <var>o</var> is object or using {@link Eloom_Log4php_Renderers_LoggerRendererDefault}. 
	 ...
	 *
	 * @param string $class
	 * @return Eloom_Log4php_Renderers_LoggerRendererObject
	 */
	...
	/**
	 * Register a {@link Eloom_Log4php_Renderers_LoggerRendererObject} for <var>clazz</var>.
	 * @param string $class
	 * @param Eloom_Log4php_Renderers_LoggerRendererObject $or
	 */
