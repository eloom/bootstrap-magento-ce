 ...
 *
 * @deprecated Use Eloom_Log4php_Appenders_LoggerAppenderPDO instead
 * @package log4php
 * @subpackage appenders
 * @since 0.9
 */
class Eloom_Log4php_Appenders_LoggerAppenderAdodb extends Eloom_Log4php_LoggerAppender {
	...
	{		
		...
		$this->layout = Eloom_Log4php_LoggerReflectionUtils::createObject('Eloom_Log4php_Layouts_LoggerLayoutPattern');
	...
	function append(Eloom_Log4php_LoggerLoggingEvent $event) {
		if ($this->canAppend) {
