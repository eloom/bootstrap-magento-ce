 ...
 */ 
class Eloom_Log4php_Appenders_LoggerAppenderSyslog extends Eloom_Log4php_LoggerAppender {
	...
	public function append(Eloom_Log4php_LoggerLoggingEvent $event) {
		...
		if(!$this->dry) {
			...
			if($this->_overridePriority) {
				...
				if($level->isGreaterOrEqual(Eloom_Log4php_LoggerLevel::getLevelFatal())) {
					syslog(LOG_ALERT, $message);
				} else if ($level->isGreaterOrEqual(Eloom_Log4php_LoggerLevel::getLevelError())) {
					syslog(LOG_ERR, $message);		  
				} else if ($level->isGreaterOrEqual(Eloom_Log4php_LoggerLevel::getLevelWarn())) {
					syslog(LOG_WARNING, $message);
				} else if ($level->isGreaterOrEqual(Eloom_Log4php_LoggerLevel::getLevelInfo())) {
					syslog(LOG_INFO, $message);
				} else if ($level->isGreaterOrEqual(Eloom_Log4php_LoggerLevel::getLevelDebug())) {
					syslog(LOG_DEBUG, $message);
				} else if ($level->isGreaterOrEqual(Eloom_Log4php_LoggerLevel::getLevelTrace())) {
