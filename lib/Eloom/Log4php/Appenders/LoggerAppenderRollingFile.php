...
/**
 * Eloom_Log4php_Appenders_LoggerAppenderRollingFile extends Eloom_Log4php_Appenders_LoggerAppenderFile to backup the log files 
 ...
 */
class Eloom_Log4php_Appenders_LoggerAppenderRollingFile extends Eloom_Log4php_Appenders_LoggerAppenderFile {
	...
	public function setFile($fileName) {
		$this->file = $fileName;
		// As Eloom_Log4php_Appenders_LoggerAppenderFile does not create the directory, it has to exist.
