 ...
 */
class Eloom_Log4php_Appenders_LoggerAppenderMailEvent extends Eloom_Log4php_LoggerAppender {
	...
	public function activateOptions() {
		if (empty($this->layout)) {
			throw new Eloom_Log4php_LoggerException("Eloom_Log4php_Appenders_LoggerAppenderMailEvent requires layout!");
		}
		if (empty($this->to)) {
			throw new Eloom_Log4php_LoggerException("Eloom_Log4php_Appenders_LoggerAppenderMailEvent was initialized with empty 'from' ($this->from) or 'to' ($this->to) Adress!");
		}
		
		$sendmail_from = ini_get('sendmail_from');
		if (empty($this->from) and empty($sendmail_from)) {
			throw new Eloom_Log4php_LoggerException("Eloom_Log4php_Appenders_LoggerAppenderMailEvent requires 'from' or on win32 at least the ini variable sendmail_from!");
		}
