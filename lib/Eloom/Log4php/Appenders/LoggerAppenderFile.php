 ...
 */
class Eloom_Log4php_Appenders_LoggerAppenderFile extends Eloom_Log4php_LoggerAppender {
	...
	public function setAppend($flag) {
		$this->append = Eloom_Log4php_Helpers_LoggerOptionConverter::toBoolean($flag, true);
	}
