 ...
 * @since 2.1
 */
class Eloom_Log4php_Appenders_LoggerAppenderMongoDB extends Eloom_Log4php_LoggerAppender {
	...
	public function activateOptions() {
		try {
			...
			throw new Eloom_Log4php_LoggerException($ex);
		} 
	 ...
	 */
	protected function format(Eloom_Log4php_LoggerLoggingEvent $event) {
