...
/**
 * Eloom_Log4php_Appenders_LoggerAppenderEcho uses {@link PHP_MANUAL#echo echo} function to output events. 
 * 
 ...
 */
class Eloom_Log4php_Appenders_LoggerAppenderEcho extends Eloom_Log4php_LoggerAppender {
	...
	public function setHtmlLineBreaks($value) {
		$this->htmlLineBreaks = Eloom_Log4php_Helpers_LoggerOptionConverter::toBoolean($value, false);
	}
