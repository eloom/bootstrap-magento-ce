 ...
 * @since 2.0
 */
class Eloom_Log4php_Appenders_LoggerAppenderPDO extends Eloom_Log4php_LoggerAppender {
	...
	public function activateOptions() {
		try {
			...
			throw new Eloom_Log4php_LoggerException($e);
		}
		
		$this->layout = new Eloom_Log4php_Layouts_LoggerLayoutPattern();
	 ...
	 * 
	 * @throws Eloom_Log4php_LoggerException If the pattern conversion or the INSERT statement fails.
	 */
	...
	public function setCreateTable($flag) {
		$this->createTable = Eloom_Log4php_Helpers_LoggerOptionConverter::toBoolean($flag, true);
	}
	...
	/**
	 * Sets the {@link Eloom_Log4php_Layouts_LoggerLayoutPattern} format strings for {@link $insertSql}.
	 *
	 * It's not necessary to change this except you have customized logging.
	 *
