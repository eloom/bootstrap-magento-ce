 ...
 *
 * This class is similar to the {@link Eloom_Log4php_LoggerMDC} class except that it is
 ...
 * - When entering a context, call <kbd>Eloom_Log4php_LoggerNDC::push()</kbd>
 *	 As a side effect, if there is no nested diagnostic context for the
 *	 current thread, this method will create it.
 * - When leaving a context, call <kbd>Eloom_Log4php_LoggerNDC::pop()</kbd>
 ...
 *
 * If configured to do so, {@link LoggerPatternLayout} and {@link Eloom_Log4php_Layouts_LoggerLayoutTTCC} 
...
class Eloom_Log4php_LoggerNDC {
	...
	/**
	 * Never use this method directly, use the {@link Eloom_Log4php_LoggerLoggingEvent::getNDC()} method instead.
	 * @static
	 * @return array
	 */
	...
	public static function setMaxDepth($maxDepth) {
		...
		if(Eloom_Log4php_LoggerNDC::getDepth() > $maxDepth) {
