...
/**
 * Pool implmentation for Eloom_Log4php_LoggerAppender instances
 *
 * @version $Revision: 795727 $
 * @package log4php
 */
class Eloom_Log4php_LoggerAppenderPool {
	/* Appender Pool */
	...
	public static function getAppenderFromPool($name, $class = '') {
		...
		$appender = Eloom_Log4php_LoggerReflectionUtils::createObject($class);
