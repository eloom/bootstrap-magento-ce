 ...
 * @since 2.1
 */
class Eloom_Log4php_LoggerThrowableInformation {
	...
	/** @var Eloom_Log4php_Logger reference */
	private $logger;
	...
	*/
	...
	public function getStringRepresentation() {
		if (!is_array($this->throwableArray)) {
			$renderer = Eloom_Log4php_Logger::getHierarchy()->getRendererMap()->getByClassName(get_class($this->throwable));
			
			// TODO: why this?
			if ($renderer instanceof Eloom_Log4php_Renderers_LoggerRendererDefault) {
				$renderer = new Eloom_Log4php_Renderers_LoggerRendererException();
			}
