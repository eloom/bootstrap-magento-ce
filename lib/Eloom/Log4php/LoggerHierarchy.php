 ...
 */
  ...
  */
class Eloom_Log4php_LoggerHierarchy {
	/** Default Factory  */
	...
	/** The root Eloom_Log4php_Logger */
	protected $root = null;
	
	/** Eloom_Log4php_Renderers_LoggerRendererMap */
	protected $rendererMap;

	/** Eloom_Log4php_LoggerLevel main level threshold */
	protected $threshold;
	 ...
	 */
	public function __construct(Eloom_Log4php_LoggerRoot $root) {
		$this->root = $root;
		$this->setThreshold(Eloom_Log4php_LoggerLevel::getLevelAll());
		$this->rendererMap = new Eloom_Log4php_Renderers_LoggerRendererMap();
	}
	...
	public function getLogger($name) {
		if(!isset($this->ht[$name])) {
			$this->ht[$name] = new Eloom_Log4php_Logger($name);;
	...
	/**
	 * @return Eloom_Log4php_Renderers_LoggerRendererMap Get the renderer map for this hierarchy.
	 */
	...
	/**
	 * @return Eloom_Log4php_LoggerRoot Get the root of this hierarchy.
	 */ 
	public function getRootLogger() {
		if(!isset($this->root) or $this->root == null) {
			$this->root = new Eloom_Log4php_LoggerRoot();
		}
		return $this->root;
	}
	 
	/**
	 * @return Eloom_Log4php_LoggerLevel Returns the threshold Level.
	 */
	 ...
	 * @return boolean
	 */
	public function isDisabled(Eloom_Log4php_LoggerLevel $level) {
	...
	public function resetConfiguration() {
		...
		$root->setLevel(Eloom_Log4php_LoggerLevel::getLevelDebug());
		$this->setThreshold(Eloom_Log4php_LoggerLevel::getLevelAll());
		$this->shutDown();
		...
		Eloom_Log4php_LoggerAppenderPool::clear();
	}
	
	/**
	 * set a new threshold level
	 *
	 * @param Eloom_Log4php_LoggerLevel $l
	 */
	public function setThreshold(Eloom_Log4php_LoggerLevel $l) {
		if($l !== null) {
			$this->threshold = $l;
		}
	}
