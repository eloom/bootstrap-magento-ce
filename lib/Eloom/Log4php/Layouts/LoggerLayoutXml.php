 ...
 * @subpackage layouts
 */
class Eloom_Log4php_Layouts_LoggerLayoutXml extends Eloom_Log4php_LoggerLayout {
	...
	/**
	 * Formats a {@link Eloom_Log4php_LoggerLoggingEvent} in conformance with the log4php.dtd.
	 *
	...
	public function setLocationInfo($flag) {
		$this->locationInfo = Eloom_Log4php_Helpers_LoggerOptionConverter::toBoolean($flag, true);
	}
	...
	public function setLog4jNamespace($flag) {
		$this->log4jNamespace = Eloom_Log4php_Helpers_LoggerOptionConverter::toBoolean($flag, true);
	}
