 ...
 * @subpackage layouts
 */
class Eloom_Log4php_Layouts_LoggerLayoutHtml extends Eloom_Log4php_LoggerLayout {
	 ...
	 *
	 * <p>If you are embedding this layout within a {@link Eloom_Log4php_Appenders_LoggerAppenderMail}
	 * or a {@link Eloom_Log4php_Appenders_LoggerAppenderMailEvent} then make sure to set the
	...
	public function format(Eloom_Log4php_LoggerLoggingEvent $event) {
		...
		if ($level->equals(Eloom_Log4php_LoggerLevel::getLevelDebug())) {
			$sbuf .= "<font color=\"#339933\">$level</font>";
		} else if ($level->equals(Eloom_Log4php_LoggerLevel::getLevelWarn())) {
