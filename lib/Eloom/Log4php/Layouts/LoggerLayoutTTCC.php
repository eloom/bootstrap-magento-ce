 ...
 * @subpackage layouts
 */
class Eloom_Log4php_Layouts_LoggerLayoutTTCC extends Eloom_Log4php_LoggerLayout {
	...
	public function setCategoryPrefixing($categoryPrefixing) {
		$this->categoryPrefixing = Eloom_Log4php_Helpers_LoggerOptionConverter::toBoolean($categoryPrefixing);
	}
	...
	public function setContextPrinting($contextPrinting) {
		$this->contextPrinting = Eloom_Log4php_Helpers_LoggerOptionConverter::toBoolean($contextPrinting); 
	}
